...
dataset3=pd.read_csv('Dataset_03.csv')
dataset3.columns
dataset3.dtypes
dataset3.shape
...
qq2=ttest_ind(Q1.forehead_ratio[Q1.gender=='Male'],
...
#(정답)
# 2.999, Y(p-value가 0.01보다 작은지로 결정)
...
dataset4=pd.read_csv('Dataset_04.csv')
...
# pvaluer 가 0.05 이상인 경우 귀무가설 기각하지 않음, 즉 채택
